...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var model, embeddings, browser, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    model = new openai_1.ChatOpenAI({ temperature: 0 });
                    embeddings = new openai_2.OpenAIEmbeddings();
                    browser = new webbrowser_1.WebBrowser({ model: model, embeddings: embeddings });
                    return [4 /*yield*/, browser.call("\"https://www.themarginalian.org/2015/04/09/find-your-bliss-joseph-campbell-power-of-myth\",\"who is joseph campbell\"")];
                case 1:
                    result = _a.sent();
                    console.log(result);
                    return [2 /*return*/];
